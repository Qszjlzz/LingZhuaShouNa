...
/// The Figma file uses Microsoft YaHei for most Chinese text. iOS does not
/// ship that Windows font, so STHeiti SC is used as the closest bundled
/// Chinese fallback while the smaller PingFang/SF Pro roles remain distinct.
enum FigmaFont {
    static func regular(_ size: CGFloat) -> Font {
        .custom("STHeitiSC-Light", size: size)
    }

    static func medium(_ size: CGFloat) -> Font {
        .custom("STHeitiSC-Medium", size: size)
    }
