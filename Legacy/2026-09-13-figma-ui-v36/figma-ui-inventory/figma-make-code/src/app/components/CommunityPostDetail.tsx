...
export function CommunityPostDetail({ onBack }: { onBack: () => void }) {
  ...
  if (tryingPlan) {
    return <TryPlanScreen onBack={() => setTryingPlan(false)} />;
  }
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 pr-3 pl-1 py-1" style={{ backgroundColor: "rgba(255,255,255,0.92)", borderRadius: 999 }}>
            <div
              ...
              style={{ backgroundColor: "#E8B894", color: WHITE, fontSize: 12, fontWeight: 600 }}
            >
              M
            </div>
            <span style={{ color: COFFEE, fontSize: 12, fontWeight: 600 }}>Mira</span>
            <button
