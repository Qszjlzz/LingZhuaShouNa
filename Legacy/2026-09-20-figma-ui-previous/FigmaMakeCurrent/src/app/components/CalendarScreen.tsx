...
const events: Event[] = [
  { id: "e1", date: 2, time: "10:00", title: "Tiny Apartment Wardrobe", space: "Bedroom", duration: "1h 12m", color: ORANGE, status: "active" },
  { id: "e2", date: 4, time: "08:30", title: "5-min Kitchen Reset", space: "Kitchen", duration: "30 min", color: BLUE, status: "scheduled" },
  { id: "e3", date: 9, time: "10:00", title: "Weekend Office Reset", space: "Home Office", duration: "45 min", color: "#A88370", status: "scheduled" },
  { id: "e4", date: 9, time: "15:00", title: "Bookshelf Sort", space: "Living Room", duration: "1h", color: BLUE, status: "scheduled" },
  { id: "e5", date: 12, time: "09:00", title: "Pantry Deep Clean", space: "Kitchen", duration: "1h 30m", color: "#7BB28F", status: "done" },
  { id: "e6", date: 16, time: "11:00", title: "Closet Edit Round 2", space: "Bedroom", duration: "50 min", color: ORANGE, status: "scheduled" },
  { id: "e7", date: 23, time: "14:00", title: "Garage Refresh", space: "Garage", duration: "2h", color: "#A88370", status: "scheduled" },
];
  ...
  return (
    <div className="h-full w-full overflow-y-auto pb-10" style={{ backgroundColor: LINEN }}>
      <div className="px-6 pt-14 pb-2 flex items-center justify-between">
        ...
        <p style={{ color: COFFEE, fontSize: 17, fontWeight: 600 }}>Calendar</p>
        <button
          className="h-11 w-11 rounded-full flex items-center justify-center"
      ...
      <div className="px-6 mt-4">
        ...
        >
          <p style={{ color: WHITE, opacity: 0.7, fontSize: 11 }}>This month</p>
      ...
      <div className="px-6 mt-7 mb-3">
        <p style={{ color: COFFEE, fontSize: 14, fontWeight: 600 }}>Upcoming this week</p>
      </div>
      <div className="px-6 space-y-2">
        {events
