...
const collections = [
  { id: "c1", name: "All", count: 24, color: ORANGE },
  { id: "c2", name: "Wardrobe", count: 8, color: "#B4D4C9" },
  { id: "c3", name: "Kitchen", count: 6, color: "#E8B894" },
  { id: "c4", name: "Tips", count: 10, color: "#B4C7DC" },
];

const posts = [
  {
    id: "p1",
    title: "Tiny apartment, huge wardrobe makeover",
    user: "Mira",
    h: 240,
  ...
  {
    id: "p5",
    title: "Office desk minimal setup",
    user: "Kai",
    h: 200,
  ...
  return (
    <div className="h-full w-full overflow-y-auto pb-10" style={{ backgroundColor: LINEN }}>
      <div className="px-6 pt-14 pb-2 flex items-center justify-between">
        ...
        <p style={{ color: COFFEE, fontSize: 17, fontWeight: 600 }}>Saved Posts</p>
        <button
          className="h-11 w-11 rounded-full flex items-center justify-center"
          style={{ backgroundColor: WHITE }}
        >
      ...
      <div className="px-6 mt-4">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p style={{ color: COFFEE, opacity: 0.55, fontSize: 12 }}>across 3 collections</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 mt-5 flex items-center justify-between mb-3">
        <p style={{ color: COFFEE, fontSize: 14, fontWeight: 600 }}>Collections</p>
