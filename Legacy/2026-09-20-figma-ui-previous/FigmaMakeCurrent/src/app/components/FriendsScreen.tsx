...
const leaderboard = [
  { rank: 1, name: "Joon", initial: "J", bg: "#A8B8CC", value: "41 spaces" },
  { rank: 2, name: "Mira", initial: "M", bg: "#E8B894", value: "28 spaces" },
  { rank: 3, name: "You", initial: "S", bg: ORANGE, value: "12 spaces", you: true },
  ...
  return (
    <div className="h-full w-full overflow-y-auto pb-10" style={{ backgroundColor: LINEN }}>
      <div className="px-6 pt-14 pb-2 flex items-center justify-between">
        ...
        <p style={{ color: COFFEE, fontSize: 17, fontWeight: 600 }}>Friends</p>
        <button
          className="h-11 w-11 rounded-full flex items-center justify-center"
      ...
      {tab === "friends" ? (
        <>
          ...
          <div className="px-6 mt-7 mb-3">
            <p style={{ color: COFFEE, fontSize: 14, fontWeight: 600 }}>Following</p>
          </div>
          <div className="px-6 space-y-2">
            {friends.map((f) => (
              <div
        ...
        <>
          <div className="px-6 mt-5 mb-3 flex items-center gap-2">
            ...
            <p style={{ color: COFFEE, fontSize: 14, fontWeight: 600 }}>This Month</p>
          </div>
          <div className="px-6 space-y-2">
            {leaderboard.map((l) => (
              <div
