...
export function MineScreen({ nativeState }: { nativeState?: NativeState | null }) {
  ...
  if (openPlans) return <MyPlansScreen nativeState={nativeState} onBack={() => setOpenPlans(false)} />;
