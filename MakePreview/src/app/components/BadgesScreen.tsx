...
const badges: Badge[] = [
  { id: "b1", name: "Tidy Raccoon", emoji: "🦝", desc: "Complete your first zone", rarity: "common", earnedAt: "Apr 12, 2026" },
  { id: "b2", name: "Sparkle Maker", emoji: "✨", desc: "Organize 5 spaces", rarity: "common", earnedAt: "Apr 18" },
  { id: "b3", name: "Champion", emoji: "🏆", desc: "10-day streak", rarity: "rare", earnedAt: "Apr 25" },
  { id: "b4", name: "Green Thumb", emoji: "🌿", desc: "Donate 20+ items", rarity: "rare", earnedAt: "Apr 30" },
  { id: "b5", name: "Box Master", emoji: "📦", desc: "Use 50+ storage tools", rarity: "epic", earnedAt: "May 1" },
  { id: "b6", name: "Bullseye", emoji: "🎯", desc: "Finish a plan in time", rarity: "epic", earnedAt: "May 2" },
  { id: "b7", name: "Diamond", emoji: "💎", desc: "Reach Level 10", rarity: "legendary", earnedAt: "May 3" },
  { id: "b8", name: "Speed Run", emoji: "⚡", desc: "Finish 5min plan in 3 min", rarity: "rare", locked: true, progress: 60 },
  { id: "b9", name: "Mind Reader", emoji: "🧠", desc: "AI accepts 50 suggestions", rarity: "epic", locked: true, progress: 32 },
  { id: "b10", name: "Sunrise", emoji: "🌅", desc: "Organize before 8 AM", rarity: "common", locked: true, progress: 0 },
  { id: "b11", name: "Phoenix", emoji: "🔥", desc: "30-day streak", rarity: "legendary", locked: true, progress: 18 },
  { id: "b12", name: "Wave", emoji: "🌊", desc: "Share 10 plans", rarity: "rare", locked: true, progress: 40 },
];

const rarityColor: Record<Badge["rarity"], { bg: string; ring: string; label: string }> = {
  common: { bg: "#B4C7DC", ring: "#B4C7DC", label: "Common" },
  rare: { bg: "#A8B8CC", ring: "#7FA8C9", label: "Rare" },
  epic: { bg: "#FA883A", ring: "#FFAA66", label: "Epic" },
  legendary: { bg: "#FFD58A", ring: "#FFB347", label: "Legendary" },
};
    ...
    <div className="relative h-full w-full overflow-hidden" style={{ backgroundColor: LINEN }}>
      <div className="h-full w-full overflow-y-auto pb-10">
        ...
        <div className="px-6 pt-14 pb-2 flex items-center justify-between">
          ...
          <p style={{ color: COFFEE, fontSize: 17, fontWeight: 600 }}>Badges</p>
          <button
            className="h-11 w-11 rounded-full flex items-center justify-center"
            style={{ backgroundColor: WHITE }}
          >
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex-1">
              <p style={{ color: WHITE, opacity: 0.7, fontSize: 11 }}>You've earned</p>
              <motion.p
                key={earnedCount}
          ...
          >
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                >
                  {active.locked ? "Keep going" : "Share Badge"}
                </button>
              </div>
            </motion.div>
          </motion.div>
